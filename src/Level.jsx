...
const floor1Material = new THREE.MeshStandardMaterial({ color: '#4ABDAC' })
const floor2Material = new THREE.MeshStandardMaterial({ color: '#4ABDAC' })
const obstacleMaterial = new THREE.MeshStandardMaterial({ color: '#FF481B' })
const wallMaterial = new THREE.MeshStandardMaterial({ color: '#F2B035' })
